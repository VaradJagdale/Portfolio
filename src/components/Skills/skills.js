...
const Skills = () => {
    return (
        <section id='skills'>
            ...
            <span className="skillDesc">Full Stack Developer with experience in building responsive web applications using the MERN stack (MongoDB, Express.js, React.js, Node.js) and MySQL. Skilled in front-end and back-end development, API integration, and database optimization, focusing on creating scalable, high-performance solutions.</span>
            ...
            <div className="skillBars">
                ...
                <div className="skillBar">
                    <img src="databasemanagement.png" alt="apidevelopment" className="skillBarImg" />
                    <div className="skillBarText">
                ...
                <div className="skillBar">
                    <img src="versioncontrol.png" alt="databasemanagement" className="skillBarImg" />
                    <div className="skillBarText">
